...
```env
# -- Server (Backend) -----------------------------------
PORT=                    # HTTP port for Express server (fallback: 8080)
...
VITE_API_BASE_URL=       # Axios base URL (default: http://localhost:8080/api)
VITE_API_URL=            # Base URL used by getImageUrl utility (default: http://localhost:8080)
```
...
### Home
![Home](/Backend/uploads/home.png)

### Services
![Services](/Backend/uploads/nav.png)

### Admin Details
![Service Details](/Backend/uploads/admin.png)

### Service Details
![Service Details](/Backend/uploads/1754070732741-vidS.mp4)
